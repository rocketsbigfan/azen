    ...
    <div
      ...
      <div className='w-full flex flex-col md:flex-row items-start md:items-end'>
        ...
        <div
          ...
          <p className='font-pingFangSCLight text-base text-white mt-2'>A ZenHive device hosted at a professional data
            center.</p>
          <div className='mt-4'>
            {
              data.map((item) => (
          ...
          <h2
            className='font-pingFangSCRegular font-semibold text-3xl md:text-[40px] md:leading-[60px] text-white mt-4'>
            999.9999 USDT
          </h2>
          <button
